...
<table class="notadded">
  ...
  tag.insertAdjacentHTML('afterbegin', `
  <table><tr>
    <td><a href="${sites[previousIndex]}" target='_top'>󰃍</a></td>
    <td class="ring-main">ネオ日本語ウェブリング<br>Neo-Nihongo Webring<br>${randomText} ${indexText}</td>
    <td><a href="${sites[nextIndex]}" target='_top'>󰃊</a></td>
  </tr></table>
  `);
